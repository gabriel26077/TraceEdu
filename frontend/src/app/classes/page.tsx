        ...
        <div className="flex bg-zinc-900 border border-zinc-800 rounded-xl p-1">
          <button 
            ...
            className={cn(
              ...
              viewMode === "grid" ? "bg-zinc-800 text-emerald-400 shadow-sm" : "text-zinc-600 hover:text-zinc-400"
            )}
          >
            <LayoutGrid size={18} />
          </button>
          <button 
            ...
            className={cn(
              "p-1.5 rounded-lg transition-all",
              viewMode === "list" ? "bg-zinc-800 text-emerald-400 shadow-sm" : "text-zinc-600 hover:text-zinc-400"
            )}
          >
            <List size={18} />
          </button>
          ...
          <div key={period} className="space-y-6">
            ...
            <div className={cn(
              ...
              {items
                ...
                .map(group => (
                <div key={group.uid} className={cn(
                  "glass-card hover:border-emerald-500/30 transition-all group overflow-hidden",
                  viewMode === "list" ? "p-4" : "flex flex-col"
                )}>
                  {viewMode === "grid" ? (
                    /* GRID CARD VIEW */
                    <div className="flex flex-col h-full">
                      ...
                      <div className="p-4 bg-zinc-900/20 border-t border-zinc-800 flex justify-between items-center group-hover:bg-zinc-900/40 transition-colors">
                        ...
                        <Link href={`/classes/${group.uid}`} className="text-emerald-500 text-[10px] font-black uppercase tracking-widest flex items-center gap-1 hover:gap-2 transition-all">
